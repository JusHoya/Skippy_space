 ...
 * of failing.
 */
export default function TerminalPane({ tabId }: Props) {
  ...
  useEffect(() => {
    ...
    // The PTY is bound to the tabId; if it changes (future per-agent panes),
    // we tear down the previous PTY and open a fresh one.
  }, [tabId]);
